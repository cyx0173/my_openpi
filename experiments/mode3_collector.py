...
class Args:
    ...
    # Recommended layout:
    #   /home/.../experiments/mode4/trace/<task_name>/<precision>
    # Then this script writes:
    #   <base_dir>/<precision>_action_bank/
    #   <base_dir>/<precision>_trace/
    #   <base_dir>/images/
    base_dir: str = "/home/chengyuxuan/openpi/experiments/mode4/trace/w4a4"
