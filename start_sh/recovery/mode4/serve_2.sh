...
BASE_DIR="/home/chengyuxuan/openpi/experiments/mode4"
...
# start_server 8006 6 1 "w4a4"
# start_server 8007 7 1 "w4a4"

start_server 8008 0 1 "w4a4"
start_server 8009 1 1 "w4a4"

start_server 8010 2 1 "w4a4"
start_server 8011 3 1 "w4a4"

start_server 8012 4 1 "w4a4"
start_server 8013 5 1 "w4a4"

start_server 8014 6 1 "w4a4"
start_server 8015 7 1 "w4a4"
